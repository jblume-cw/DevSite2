...
(function (PhaserInput) {
  ...
  var InputElement = (function () {
    function InputElement(game, id, type, value, focusIn, focusOut) {
      ...
      this.element.style.left = (-1000).toString() + "px"; // Changed from -40 to -1000 2.17.26 by Jeff Blume to keep this from appearing in the browser
      ...
      // Changed 2.17.26 by Jeff Blume to fix fullscreen and scrolling issues. See: https://github.com/azerion/phaser-input/issues/74
    ...
    InputElement.prototype.destroy = function () {
      ...
      // Changed 2.17.26 by Jeff Blume to fix fullscreen and scrolling issues. See: https://github.com/azerion/phaser-input/issues/74
      document.getElementById("gameContainer").removeChild(this.element);
    };
  ...
  var InputBox = (function (_super) {
    ...
    function InputBox(game, inputOptions) {
      ...
      _this.bgColor = inputOptions.backgroundColor
        ...
        : 0xffffff;
      _this.borderRadius = inputOptions.borderRadius =
        typeof inputOptions.borderRadius === "number"
          ? inputOptions.borderRadius
          : 0;
      _this.borderWidth = inputOptions.borderWidth =
        typeof inputOptions.borderWidth === "number"
          ? inputOptions.borderWidth
          : 1;
