...
(function () {
    ...
    var PreloadState = Base.extend({
        ...
        preload: function () {
            ...
            this.act = new GroceryGalaxy(this.game, this.game.actnow.theme, "grocerygalaxy");
            this.act.preload();
